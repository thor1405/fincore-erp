...
function ExecutiveReportSheet({ title, timeframe, data, formatCurrency }) {
      ...
      <div className={styles.modalOverlay}>
        <div className={styles.modalContainer}>
          ...
          <div className={styles.documentViewport}>
            <ExecutiveReportSheet title={title} timeframe={timeframe} data={data} formatCurrency={formatCurrency} />
          </div>
        </div>
      </div>

      {/* Dedicated Top-Level Portal attached directly to <body> for pristine printing */}
      {createPortal(
        <div className={styles.printOnlyPortal}>
          <ExecutiveReportSheet title={title} timeframe={timeframe} data={data} formatCurrency={formatCurrency} />
        </div>,
        document.body
      )}
