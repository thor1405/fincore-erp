    ...
    },
    {
      ...
      render: (_, row) => (
        <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
          <button style={{ background: 'transparent', border: 'none', cursor: 'pointer', color: 'var(--color-indigo)' }} onClick={() => navigate(`/customers/${row.id}`)} title="View Profile"><Eye size={16} /></button>
          {canEdit && (
            <>
